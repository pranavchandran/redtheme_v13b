...
_lr_productions = [
  ...
  ('expr -> expr PLUS term','expr',3,'p_expr','parsing_tools.py',40),
  ('expr -> expr MINUS term','expr',3,'p_expr','parsing_tools.py',41),
  ('expr -> term','expr',1,'p_expr_term','parsing_tools.py',50),
  ('term -> term TIMES factor','term',3,'p_term','parsing_tools.py',56),
  ('term -> term DIVIDE factor','term',3,'p_term','parsing_tools.py',57),
  ('term -> factor','term',1,'p_term_factor','parsing_tools.py',66),
  ('factor -> NUM','factor',1,'p_factor','parsing_tools.py',72),
  ('factor -> LPAREN expr RPAREN','factor',3,'p_factor_group','parsing_tools.py',78),
]
